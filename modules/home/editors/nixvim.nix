  ...
  programs.nixvim = {
    ...
    extraPlugins = [
      (pkgs.vimUtils.buildVimPlugin {
        ...
        src = pkgs.fetchFromGitHub {
          owner = "DingDean";
          repo = "wgsl.vim";
          rev = "master"; # pin a specific commit hash instead for reproducibility
          sha256 = "sha256-2+slQRWbBLmMYOFfFvCV1BxS+0iUwCYEHKMEzJb1H1o="; # leave empty first, nix build will tell you the correct hash
        };
      })
    ];
    globals = {
    ...
    plugins = {
      ...
      treesitter = {
        ...
        languageRegister.slang = "shaderslang";
      };
