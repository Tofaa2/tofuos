...
- Repo location is expected at ~/tofuos. If you place it elsewhere, update modules/core/nh.nix (programs.nh.flake) to the new path.
...
- modules/core
  ...
  - nh.nix enables nh, configures GC, and pins programs.nh.flake = /home/${username}/tofuos
- modules/drivers
...
- If the repo is not under tofuoss, update modules/core/nh.nix so zcli/nh operate on the correct path
